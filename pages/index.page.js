  ...
  return (
    <App>
      <div className={s.container}>
        ...
        <Link href={`bills`}>Bills {summery.bill.toLocaleString("en-IN")}</Link>
        <Link href={`fabrics`}>
          Fabrics {summery.fabric.toLocaleString("en-IN")}
        </Link>
        <Link href={`costings`}>Costings</Link>
        <Link href={`wages`}>Wages {summery.wage.toLocaleString("en-IN")}</Link>
        <Link href={`productions`}>
          Productions {summery.production.toLocaleString("en-IN")}
        </Link>
        <Link href={`/transactions/wages`}>
          <IoSwapVerticalOutline /> Wages{" "}
